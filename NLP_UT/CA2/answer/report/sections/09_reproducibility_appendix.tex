...
\midrule
\path{q1_confusion_matrices.png} & Side-by-side confusion matrices for from-scratch Q1 models & Q1 results \\
\path{q1_roc_pr_curves_lr.png} & ROC and Precision-Recall curves for Q1 Logistic Regression & Q1 results \\
\path{q1_top_words_spam_ham.png} & Top class-specific BoW terms from \path{emails_1.csv} & Q1 results \\
\path{q1_model_comparison_bar.png} & Metric bar chart for Q1 model comparison & Q1 results \\
\path{q2_structural_distributions.png} & Histograms of structural URL features & Q2 results \\
\path{q2_correlation_heatmap_all_features.png} & Correlation structure of combined URL features & Q2 results \\
\path{q2_structural_boxplots.png} & Class-conditional spread for key structural features & Q2 results \\
\path{q2_pairplot_sample.png} & Pairwise sampled visualization of combined features & Q2 results \\
\path{q2_top_mean_abs_correlations.png} & Top features by mean absolute correlation & Q2 results \\
\path{q2_roc_combined_features.png} & ROC comparison on combined feature set & Q2 results \\
\path{q2_pr_combined_lr.png} & PR curve for combined-feature Logistic Regression & Q2 results \\
\path{q2_lr_feature_importance.png} & Positive/negative coefficient importance plot & Q2 results \\
\bottomrule
\end{tabular}
\end{table*}
