...
\begin{tabular}{|c|c|c|}
\hline
مجموعه داده & تعداد نمونه‌ها (CBOW) & تعداد نمونه‌ها (Skip-Gram) \\
\hline
...
\begin{tabular}{|c|c|c|c|}
\hline
مجموعه & میانگین طول & میانه طول & حداکثر طول \\
\hline
آموزشی & ۲۸.۴ & ۲۶ & ۶۵ \\
...
\begin{itemize}
\item پیاده‌سازی موفق مدل‌های CBOW و Skip-Gram از پایه
\item مقایسه عملکردی دو مدل با معیارهای مختلف
\item تحلیل روابط معنایی بین کلمات با استفاده از embeddingها
\item پیاده‌سازی سیستم طبقه‌بندی اخبار با دقت ۸۵\%
\item استفاده از FastText برای embedding متون
\end{itemize}

\subsection{آموزش‌های آموخته شده}
\begin{enumerate}
\item اهمیت انتخاب مناسب معماری مدل بر اساس نوع داده
\item نقش preprocessing در کیفیت مدل‌های زبانی
\item مزایای استفاده از embeddingهای پیش‌آموزش دیده
\item چالش‌های طبقه‌بندی متون با موضوعات overlap
\end{enumerate}

\subsection{پیشنهادات برای بهبود}
برای بهبود عملکرد می‌توان از مدل‌های پیچیده‌تر مانند Transformerها، BERT، یا fine-tuning روی embeddingهای پیش‌آموزش دیده استفاده کرد. همچنین افزایش داده‌های آموزشی و استفاده از تکنیک‌های data augmentation می‌تواند مفید باشد.
