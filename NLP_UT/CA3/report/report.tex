...
\hline
آموزشی & ۴,۲۱۳,۴۵۶ & ۸,۴۲۶,۹۱۲ \\
اعتبارسنجی & ۴۶۲,۳۲۴ & ۹۲۴,۶۴۸ \\
آزمون & ۵۲۳,۶۷۲ & ۱,۰۴۷,۳۴۴ \\
\hline
\end{tabular}
...
نتایج عددی آموزش:
\begin{itemize}
\item CBOW: Loss نهایی = ۵.۲, زمان آموزش = ۱۲ دقیقه
\item Skip-Gram: Loss نهایی = ۴.۸, زمان آموزش = ۱۸ دقیقه
\end{itemize}
...
\item پیاده‌سازی سیستم طبقه‌بندی اخبار با دقت ۸۵\% با استفاده از FastText
