...
\begin{itemize}
  \item Legacy CSV Processor — fixed \texttt{src/analyzer.py}, tests passing (\texttt{4 passed}), log in \texttt{test\_projects/legacy\_csv\_processor/.coding\_agent\_logs/}.
  ...
  \item Bigram Language Model — added Laplace smoothing, log-prob scoring, sampler improvements and \texttt{top\_next}, tests passing (\texttt{6 passed}), log in \texttt{test\_projects/bigram\_generator/.coding\_agent\_logs/}.
\end{itemize}
