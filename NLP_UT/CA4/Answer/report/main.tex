...
\begin{enumerate}
    ...
    \item Run \texttt{python3 scripts/run\_pipeline.py all-smoke}.
    \item Confirm \texttt{artifacts/q1\_metrics.json}.
    \item Confirm \texttt{artifacts/q2\_metrics.json}.
    \item Confirm \texttt{report/generated\_metrics.tex}.
    \item Confirm \texttt{report/figures/q1\_em\_comparison.png}.
    \item Confirm \texttt{report/figures/q1\_error\_types.png}.
    \item Confirm \texttt{report/figures/q2\_ifeval\_comparison.png}.
    \item Confirm \texttt{report/main.pdf}.
